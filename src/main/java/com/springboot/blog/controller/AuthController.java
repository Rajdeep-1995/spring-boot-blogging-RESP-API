...
import com.springboot.blog.paylaod.LoginDto;
import com.springboot.blog.paylaod.SignUpDto;
...
public class AuthController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<String> authanticateUser(@RequestBody LoginDto loginDto){
      Authentication authentication = authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(loginDto.getUsernameOrEmail(),
                loginDto.getPassword()));

        SecurityContextHolder.getContext().setAuthentication(authentication);
        return new ResponseEntity<String>("user sign-in successful!", HttpStatus.OK);
    }
